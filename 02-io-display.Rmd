...
```{r plot-las-truncks, echo = FALSE, rgl = TRUE, fig.width = 4, fig.height = 3}
LASfile <- system.file("extdata", "MixedConifer.laz", package="lidR")
las <- readLAS(LASfile, select = "xyzc")
ttops <- find_trees(las, lmf(ws = 5)) # get the location of the trees
...
From v3.2.0 it is possible to render voxels. This is useful to render the output of the function `voxelise_points()` or `voxel_metrics()` for examples.
