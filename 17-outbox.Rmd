...
### Distance between returns {#outbox-dr}
...
Then we define a function that respects some requirement imposed by the `LAScatalog` processing engine (section \@ref(engine2)).
