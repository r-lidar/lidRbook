...
It's also possible to compute metrics for each tree. We go further into this functionality chapter \@ref(tba), but here is a brief example where crowns are colored by their area.
