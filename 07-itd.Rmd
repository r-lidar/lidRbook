...
```{r, rgl = TRUE, fig.width = 5, fig.height = 4}
...
```{r, rgl = TRUE, fig.width = 5, fig.height = 4, warning = FALSE}
...
```{r, rgl = TRUE, fig.width = 3, fig.height = 4}
...
```{r, rgl = TRUE, warning = FALSE, fig.height=6, fig.width=8}
