...
One can reproduce this with other algorithm such as `tin()`. It is also important to recall here that the question of buffer and edge artifact also applies here.
