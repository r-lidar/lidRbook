...
* Perform individual tree segmentation (chapter \@ref(itd))
...
* Manage processing for sets of point-cloud files - referred to as a `LAScatalog` (chapter \@ref(engine) and \@ref(engine2))
