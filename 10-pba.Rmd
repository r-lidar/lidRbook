...
We can then apply this function with `point_metrics()` using a spherical neighborhood radius of `r = 0.5`. We then attribute the output of `point_metrics()` back into the `LAS` object for a nice display.
