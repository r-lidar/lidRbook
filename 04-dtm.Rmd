...
Spatial interpolation is not limited to the 3 methods described above. Many more have been presented and described in the literature. In section \@ref(plugins) we will learn how to create a plugin algorithm compatible with `rasterize_terrain()` based on a multilevel B-spline approximation (MBA) using the [`MBA`](https://cran.r-project.org/web/packages/MBA/index.html) package.
