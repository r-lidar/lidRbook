...
This example can be improved. In section \@ref(engine) we will study how to extract a ground inventory and in section \@ref(modeling-aba) we will study more in depth modelling presenting a complete workflow from the plot extraction to the mapping of the predictive model.
